...
int main(int argc, char* argv[]) {
    ...
    toporeader.SetFileName("/home/user/retx_env/retx/scenarios/topo_chain");
    toporeader.Read();
    ...
    consumerHelper.SetAttribute("ReactToNack", BooleanValue(true));
    // consumerHelper.SetAttribute("CubicBeta", DoubleValue(0.7));
    ...
    ndn::AppDelayTracer::InstallAll("log/chain-cubic-len32-retx-0.8.txt");
