 ...
 *
 * This app uses the algorithms from "A Practical Congestion Control Scheme for
 * Named Data Networking" (https://dl.acm.org/citation.cfm?id=2984369).
 *
 ...
 */
class ConsumerPconManip : public ConsumerWindow {
  public:
  ...
  private:
    ...
    //! Sets the maximum (linear) increase of TCP BIC. Should be between 8
    //! and 64.
    static constexpr uint32_t BIC_MAX_INCREMENT = 8;
